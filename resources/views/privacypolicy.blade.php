...
@section('content')
    ...
    <div class="container">
        <h1>Privacy Policy for Socialite Example</h1>

        <p>At Socialite Example, accessible from http://localhost:8000/, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by Socialite
            Example and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
            to the information that they shared and/or collect in Socialite Example. This policy is not applicable to any
        ...
        <p>Socialite Example follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>Like any other website, Socialite Example uses 'cookies'. These cookies are used to store information including
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Socialite Example.
        </p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
            their respective advertisements and links that appear on Socialite Example, which are sent directly to users'
        ...
        <p>Note that Socialite Example has no access to or control over these cookies that are used by third-party
            advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>Socialite Example's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>Socialite Example does not knowingly collect any Personal Identifiable Information from children under the age of
